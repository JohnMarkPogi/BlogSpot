...
function signup(){
    ...
    function menu(){
        ...
        document.getElementById("signup").style.marginTop="-510px";
        document.getElementById("container-login").style.marginTop="-502px";
    ...
    function menuBack1(){
        ...
        //to not create different margin and back to default
        document.getElementById("signup").style.marginTop= "-507px";
        document.getElementById("container-login").style.marginTop="-502px";
    ...
    function menuBack(){
        ...
        document.getElementById("home-back").style.display="none";
        //to not create different margin and back to default
        document.getElementById("signup").style.marginTop= "80px";
        document.getElementById("container-login").style.marginTop="-502px";
    ...
    function menuBack2(){
        ...
        //to not create different margin and back to default
        document.getElementById("signup").style.marginTop= "80px";
        document.getElementById("container-login").style.marginTop=" 80px";
